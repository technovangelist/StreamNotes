Primary service offered by an [IdP](IdP.md)
...
These are sometimes used on their own or in combination with others. When you hear the term **MFA**, they mean Two Factor Authentication and Multi Factor Authentication. So they use two or more factors: a password and [OTP](OTP.md) or **FaceID**. 
